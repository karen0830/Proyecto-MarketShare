        ...
        <div className="flex flex-col w-full bg-gray-900">
          ...
          <div className="flex flex-col flex-0 lg:flex-row items-center max-w-5xl w-full mx-auto px-32 lg:h-72">
            ...
            <div className="flex flex-col items-center lg:items-start mt-16 lg:mt-0 lg:ml-32">
              <Typography className="text-lg font-bold leading-none text-white">
                Brian Hughes
              </Typography>
            ...
            <div className="flex items-center mt-24 lg:mt-0 space-x-24">
              <div className="flex flex-col items-center">
                <Typography className="font-bold text-white">200k</Typography>
                <Typography
              ...
              <div className="flex flex-col items-center">
                <Typography className="font-bold text-white">1.2k</Typography>
                <Typography
                  className="text-sm font-medium"
                  color="text.secondary"
                >
            ...
            <div className="flex flex-1 justify-end my-16 lg:my-0">
              ...
              >
                <Tab
                  className="text-14 font-semibold min-h-40 min-w-64 mx-4 px-12 text-white"
                  disableRipple
                  label="Timeline"
                />
                <Tab
