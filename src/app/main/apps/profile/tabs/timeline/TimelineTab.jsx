      ...
      <div className="md:flex ">
        <div className="flex flex-col w-full md:w-320 md:ltr:mr-32 md:rtl:ml-32">
          <Card
            ...
            variants={item}
            className="flex flex-col w-full px-32 pt-24 bg-gray-900"
          >
            <div className="flex justify-between items-center pb-16">
              <Typography className="text-2xl font-semibold leading-tight text-white">
                Latest Activity
              </Typography>
              <Button size="small" className="font-medium -mx-8 text-blue-700">
                See All
              </Button>
            </div>
