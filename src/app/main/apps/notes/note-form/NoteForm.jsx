...
import { useCreateNotesItemMutation, useDeleteNotesItemMutation, useUpdateNotesItemMutation } from '../NotesApi';
...
function NoteForm(props) {
	...
	const { formState, handleSubmit, getValues, watch, reset, setValue, control } = useForm({
		mode: 'onChange',
